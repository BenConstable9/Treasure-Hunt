...
conn.execute('CREATE TABLE IF NOT EXISTS Teams (TeamID integer PRIMARY KEY AUTOINCREMENT, TeamName string not null, Password string not null, Subject string not null)')
print ("Table created successfully");
